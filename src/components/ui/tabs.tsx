...
const tabsListVariants = cva('flex items-center shrink-0', {
    variants: {
        variant: {
            default: 'bg-slate-200/60 p-1.5 backdrop-blur-sm shadow-inner',
            button: '',
    ...
    compoundVariants: [
        { variant: 'default', size: 'lg', className: 'p-1.5' },
        { variant: 'default', size: 'md', className: 'p-1' },
        { variant: 'default', size: 'sm', className: 'p-1' },
        { variant: 'default', size: 'xs', className: 'p-1' },
...
const tabsTriggerVariants = cva(
    'shrink-0 cursor-pointer whitespace-nowrap inline-flex justify-center flex-1 items-center font-bold ring-offset-background transition-all duration-200 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:shrink-0 [&_svg]:text-muted-foreground [&:hover_svg]:text-primary [&[data-state=active]_svg]:text-primary',
    {
        variants: {
            variant: {
                default:
                    'text-gray-500 data-[state=active]:bg-white data-[state=active]:text-black data-[state=active]:shadow-[0_2px_8px_-1px_rgba(0,0,0,0.08),0_1px_4px_-1px_rgba(0,0,0,0.02)] hover:text-black',
                button:
            ...
            size: {
                lg: 'gap-2.5 [&_svg]:size-5 text-[15px] h-full',
                md: 'gap-2 [&_svg]:size-4 text-sm h-full',
                sm: 'gap-1.5 [&_svg]:size-3.5 text-xs h-full',
                xs: 'gap-1 [&_svg]:size-3.5 text-xs h-full',
            },
        },
        compoundVariants: [
            { variant: 'default', size: 'lg', className: 'px-4 rounded-[10px]' },
            { variant: 'default', size: 'md', className: 'px-3 rounded-md' },
            { variant: 'default', size: 'sm', className: 'px-2.5 rounded-sm' },
            { variant: 'default', size: 'xs', className: 'px-2 rounded-sm' },
