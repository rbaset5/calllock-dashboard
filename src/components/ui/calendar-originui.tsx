...
export type CalendarOriginUIProps = React.ComponentProps<typeof DayPicker>;

function CalendarOriginUI({
  className,
  classNames,
  showOutsideDays = true,
  components: userComponents,
  ...props
}: CalendarOriginUIProps) {
...
CalendarOriginUI.displayName = "CalendarOriginUI";

export { CalendarOriginUI };
